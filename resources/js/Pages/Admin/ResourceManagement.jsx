...
export default function ResourceManagement({ languages = [] }) {
  ...
  const openLanguageWorkspace = (major) => {
    window.location.href = `${admin_app_url}/resources/workspace?major=${encodeURIComponent(major)}`;
  };
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Select a channel/major to manage resources.
            </Typography>
          </Box>
        </Box>
...
ResourceManagement.layout = (page) => <AdminLayout children={page} />;
