...
export default function SongManagement({ languages = [] }) {
  ...
  const openLanguageWorkspace = (major) => {
    window.location.href = `${admin_app_url}/songs/workspace?major=${encodeURIComponent(major)}`;
  };
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Select a channel/major to manage songs.
            </Typography>
          </Box>
        </Box>
...
SongManagement.layout = (page) => <AdminLayout children={page} />;
