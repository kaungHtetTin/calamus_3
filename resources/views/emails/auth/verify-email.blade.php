                ...
                <table role="presentation" width="100%" style="max-width:520px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e4e4e7;">
                    <tr>
                        <td style="padding:28px 28px 8px 28px;">
                            ...
                            <h1 style="margin:12px 0 0 0;font-size:22px;font-weight:600;color:#18181b;line-height:1.3;">Verify your email address</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:8px 28px 24px 28px;color:#3f3f46;font-size:15px;line-height:1.6;">
                            ...
                            <p style="margin:0 0 16px 0;">Use this code to confirm that <strong>{{ $email }}</strong> belongs to you. Enter it in the app where prompted.</p>
