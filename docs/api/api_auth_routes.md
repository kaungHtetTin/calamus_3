...
| GET    | `/games/words/random`           | Random game word (by `major`)                  |
| GET    | `/games/scores/leaderboard`    | Game leaderboard (by `major`)                  |
| POST   | `/games/scores`                | Submit high score (high-score-only)           |
...
| POST   | `/discussions/share`                  | Share a discussion post                 |
